...
## 对象内存结构[详见jvm](https://march1995.github.io/2018/10/31/java/jvm/jvm(1)
...
![MarkWord](https://march1995.github.io/uploads/java/concurrent/MarkWord.png)
...
![JVM内置锁优化升级过程](https://march1995.github.io/uploads/java/concurrent/JVM内置锁优化升级过程.png)

![锁优化升级过程](https://march1995.github.io/uploads/java/concurrent/锁优化升级过程.png)

![JVM锁的膨胀升级](https://march1995.github.io/uploads/java/concurrent/JVM锁的膨胀升级.jpg)

# Lock

![lock](https://march1995.github.io/uploads/java/concurrent/lock.png)
...
![CLH队列](https://march1995.github.io/uploads/java/concurrent/CLH队列.png)

## 条件队列

Condition是一个多线程间协调通信的工具类，使得某个，或者某些线程一起等待某个条件（Condition）,只有当该条件具备时 ，这些等待线程才会被唤醒，从而重新争夺锁

![条件队列](https://march1995.github.io/uploads/java/concurrent/条件队列.png)

## 公平锁

![公平锁](https://march1995.github.io/uploads/java/concurrent/公平锁.png)

## 非公平锁

![非公平锁](https://march1995.github.io/uploads/java/concurrent/非公平锁.png)

## 重入锁

![重入锁](https://march1995.github.io/uploads/java/concurrent/重入锁.png)

## 不可重入锁

![不可重入锁](https://march1995.github.io/uploads/java/concurrent/不可重入锁.png)
